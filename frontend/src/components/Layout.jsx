        ...
        duration-300 hover:border-sky-100 group'>
            <div className='flex items-center gap-2'>
                ...
                <div className='min-w-0'>
                    <p className='text-lg sm:text-xl font-bold bg-gradient-to-r from-sky-400 to-sky-600
            ...
            <div className='grid grid-cols-1 xl:grid-cols-3 gap-4 sm:gap-6'>
                ...
                <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
                        ...
                        <div className='space-y-2 sm:space-y-3'>
                            <div className='flex items-center justify-between text-gray-700'>
                                <span className='text-xs sm:text-sm font-medium flex items-center gap-1.5'>
                                    <Circle className='w-2.5 h-2.5 sm:w-3 sm:h-3 text-sky-500 fill-sky-500'/>
                                    Task Progress
                                </span>
                                <span className='text-xs bg-sky-100 text-sky-700 px-1.5 py-0.5 sm:px-2
                                rounded-full'>
                            ...
                            <div className='relative pt-1'>
                                <div className='flex gap-1.5 items-center'>
                                    <div className='flex-1 h-2 sm:h-3 bg-sky-100 rounded-full
                                    overflow-hidden'>
                    ...
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-sky-100'>
                        ...
                        items-center gap-2'>
                            <Clock className='w-4 h-4 sm:w-5 text-sky-50'/>
                            Recent Activity
                        </h3>
                        <div className='space-y-2 sm:space-y-3'>
                            {tasks.slice(0,3).map((task)=>(
                                ...
                                justify-between p-2 sm:p-3 hover:bg-sky-50/50 rounded-1g
                                    transition-colors duration-200 border border-transparent hover:border-sky-100'>
                            ...
                            {tasks.length === 0 && (
                                <div className=' text-center py-4 sm:py-6 px-2'>
                                    ...
                                    bg-sky-100 flex items-center justify-center'>
                                        <Clock className=' w-6 h-6 sm:w-8 sm:h-8text-sky-500' />
                                </div>
