    ...
    const StatCard =({title,value,icon})=>(
        ...
        duration-300 hover:border-purple-100 group'>
            <div className='flex items-center gap-2'>
                <div className='p-1.5 rounded-lg bg-gradient-to-br from-fuchsia-500/10 to-purple-500/10 group-hover:from-fuchsia-500
                ...
                <div className='xl:col-span-1 space-y-4 sm:space-y-6'>
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                        ...
                        flex items-center gap-2'>
                            <TrendingUp className='w-4 h-4 sm:w-5 text-purple-500'/>
                            Task Statistics
                        </h3>
                    ...
                    <div className='bg-white rounded-xl p-4 sm:p-5 shadow-sm border border-purple-100'>
                        ...
                        items-center gap-2'>
                            <Clock className='w-4 h-4 sm:w-5 text-purple-50'/>
                            Recent Activity
                        </h3>
                        <div className='space-y-2 sm:space-y-3'>
                            {tasks.slice(0,3).map((task)=>(
                                ...
                                justify-between p-2 sm:p-3 hover:bg-purple-50/50 rounded-1g
                            ...
                            {tasks.length === 0 && (
                                <div className=' text-center py-4 sm:py-6 px-2'>
                                    ...
                                    bg-purple-100 flex items-center justify-center'>
                                        <Clock className=' w-6 h-6 sm:w-8 sm:h-8text-purple-500' />
                                </div>
