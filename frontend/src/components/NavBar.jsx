           ...
           {/*logo*/}
            <div className='flex items-center gap-2 cursor-pointer group'
                    onClick={()=>navigate('/')}>
                        ...
                        to-indigo-500 bg-clip-text text-transparent tracking-wide'> Task
                    ...
                    <div className='flex items-center gap-4'>
                        ...
                        <div ref={menuref} className='relative'>
                            ...
                            rounded-full cursor-pointer hover:bg-purple-50 transition-colors duration-300 border
                            ...
                            {menuOpen && (
                                ...
                                shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn '>
                                    ...
                                    <li className='p-2'>
                                        ...
                                        className='w-full px-4 py-2.5 text-left hover:bg-purple-50
