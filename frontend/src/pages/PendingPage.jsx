  ...
  const [showModal,setShowModal] =useState(false)
   ...
   const getHeaders=()=>{
    ...
    if(!token) throw new Error ("No auth token found")
      return {'Context-Type':'application/json',Authorization:`Bearer ${token}`}
  }
  ...
  return (
    <div className={layoutClasses.container}>
      <div className={layoutClasses.headerWrapper}>
        <div>
          <h1 className='text-2xl md:text-3xl font-bold text-gray-800 flex items-center gap-2'>
            <ListChecks className='text-sky-500'/> Pending Task
          </h1>
      ...
      <div className={layoutClasses.addBox} onClick={()=>setShowModal(true)}>
        <div className='flex items-center justify-center gap-3 text-gray-500 group-hover:text-sky-600
        transition-colors'>
      ...
      onClose ={()=>{setShowModal(false);setSelectTask(null);refreshTasks();}}
